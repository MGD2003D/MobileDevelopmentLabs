...
class ProfileViewModel : ViewModel() {
    ...
    fun updateName(newName: String) { if (name.value != newName) name.value = newName }
    fun updateStatus(newStatus: String) { if (status.value != newStatus) status.value = newStatus }
